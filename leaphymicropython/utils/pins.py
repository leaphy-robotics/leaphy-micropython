...
def set_pwm(pin: str, value: int, freq: int = 50):
    """Sets a pwm pin
    :param pin: str, the pin to set
...
def read_pwm(pin: str):
    """
    Reads a pwm pin
    :param pin: str, the pin to read
